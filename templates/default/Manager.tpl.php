...
<div class="wdn_notice">
	...
	<div class="message">
		<h4>Recurring Events Notice</h4>
		<p>The creation of recurring events have been disabled due to ongoing problems.  We are working to bring back this functionality.  In the meantime, if you need to edit an event please edit them individually.</p>
	</div>
</div>
                <?php
                if (isset($this->user)) { 
