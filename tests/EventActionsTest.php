...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'UNL_UCBCN_Manager_EventActionsTest::main');
}
...
if (PHPUnit_MAIN_METHOD == 'UNL_UCBCN_Manager_EventActionsTest::main') {
    UNL_UCBCN_Manager_EventActionsTest::main();
}
?>